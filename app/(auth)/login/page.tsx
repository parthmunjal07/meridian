    ...
    <div className="flex min-h-screen items-center justify-center bg-[#F9FAFB] p-4 font-sans selection:bg-blue-500/30 relative">
      ...
      <div className="w-full max-w-[400px] space-y-8 bg-white p-10 rounded-2xl border border-zinc-200 shadow-xl relative overflow-hidden">
        ...
        <div className="text-center">
          <h2 className="text-2xl font-bold tracking-tight text-zinc-900 mb-2">Welcome back</h2>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full flex justify-center items-center py-2.5 px-4 rounded-full shadow-sm text-[14px] font-semibold text-white bg-zinc-900 hover:bg-zinc-800 focus:outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed mt-2"
          >
            {loading ? (
...
function LoginFallback() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F9FAFB] p-4">
      <div className="w-full max-w-[400px] space-y-8 bg-white p-10 rounded-2xl border border-zinc-200 shadow-xl">
